...
//채팅창이 열리면 대화차으 메시지 입력창, 대화명 표시란으로 사용할 DOM 객체 저장
...
webSocket.onerror = function(event) {
	alert(event.data);
	chatWindow.innerHTML += "채팅중 에러가 발생하였습니다.<br>";
};
...
<style>
#chatWindow{border:1px solid black; width:270px; height:310px; overflow:scroll;
			padding:5px;}
